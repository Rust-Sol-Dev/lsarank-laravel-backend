...
class RegisterFreeKeywordRankingJobsCommand extends Command
{
    use ProxyRotation;
     ...
     * @var string
     */
    protected $signature = 'register:free:lsa:ranking:job';
     ...
     * @var string
     */
    protected $description = 'Register a batch of LSA ranking (scraping) job for keywords where enabled (free)';
